...
public class MultipleStatusView extends RelativeLayout {
    ...
    private View mStatusNoNetworkView;
    private View mStatusContentView;
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.view_status_empty);
        mErrorViewResId = a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.view_status_error);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.view_status_loading);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultipleStatusView_noNetworkView, R.layout.view_status_no_network);
...
//        mInflater = LayoutInflater.from(context);
    ...
    protected void onDetachedFromWindow() {
        ...
        clear(mStatusEmptyView, mStatusLoadingView, mStatusErrorView, mStatusNoNetworkView);
        if (null != mOtherIds) {
            mOtherIds.clear();
        }
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mStatusEmptyView) {
            mStatusEmptyView = view;
            View emptyRetryView = mStatusEmptyView.findViewById(R.id.ui_empty_retry_view);
            if (null != mOnRetryClickListener && null != emptyRetryView) {
                emptyRetryView.setOnClickListener(mOnRetryClickListener);
            }
            mOtherIds.add(mStatusEmptyView.getId());
            addView(mStatusEmptyView, 0, layoutParams);
        }
        showViewById(mStatusEmptyView.getId());
    }
    ...
    public final void showError(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mStatusErrorView) {
            mStatusErrorView = view;
            View errorRetryView = mStatusErrorView.findViewById(R.id.ui_error_retry_view);
            if (null != mOnRetryClickListener && null != errorRetryView) {
                errorRetryView.setOnClickListener(mOnRetryClickListener);
            }
            mOtherIds.add(mStatusErrorView.getId());
            addView(mStatusErrorView, 0, layoutParams);
        }
        showViewById(mStatusErrorView.getId());
    }
    ...
    public final void showLoading(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mStatusLoadingView) {
            mStatusLoadingView = view;
            mOtherIds.add(mStatusLoadingView.getId());
            addView(mStatusLoadingView, 0, layoutParams);
        }
        showViewById(mStatusLoadingView.getId());
    }
    ...
    public final void showNoNetwork(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mStatusNoNetworkView) {
            mStatusNoNetworkView = view;
            View noNetworkRetryView = mStatusNoNetworkView.findViewById(R.id.ui_no_network_retry_view);
            if (null != mOnRetryClickListener && null != noNetworkRetryView) {
                noNetworkRetryView.setOnClickListener(mOnRetryClickListener);
            }
            mOtherIds.add(mStatusNoNetworkView.getId());
            addView(mStatusNoNetworkView, 0, layoutParams);
        }
        showViewById(mStatusNoNetworkView.getId());
    }
    ...
    public final void showContent() {
        ...
        if (null == mStatusContentView && mContentViewResId != NULL_RESOURCE_ID && mInflater != null) {
            mStatusContentView = mInflater.inflate(mContentViewResId, null);
            addView(mStatusContentView, 0, DEFAULT_LAYOUT_PARAMS);
        }
        showContentView();
    }
...
//        return mInflater == null ? null : mInflater.inflate(layoutId, null);
    ...
    public void updateData(boolean isEmpty) {
        if(isEmpty) {
            showEmpty();
        } else {
            showContent();
